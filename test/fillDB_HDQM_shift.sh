...
if [ ! $1 ] ;
    ...
    echo "./fillDB_historicDQM_shift.sh /castor/cern.ch/cms/store/unmerged/dqm/DQMHarvest-DQM-OfflineDQM-1219283753/DQMHarvest-DQM-OfflineDQM-1219283753-57539"
    exit 1
fi
