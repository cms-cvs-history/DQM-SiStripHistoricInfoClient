...
HistoricInspector A;
A.setDB("oracle://devdb10/CMS_COND_STRIP","historicFromT0_expert","cms_cond_strip","QG89MCVZ","COND/Services/TBufferBlobStreamingService");
A.setDebug(1);
A.setDoStat(1);
...
//---------------------------------------------------------------------------------------------------
  ...
  // for some uggly reason insert doesn't work ...
  ...
  C.plot(vRun, vSummary, vdetId, vlistItems, tagInfos, "CKFTk_trends_2D.gif", 0, 5);
