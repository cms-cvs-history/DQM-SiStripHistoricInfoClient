...
print HTMLFILE "function nav(){ var u = document.year.mylist.selectedIndex; \n";
print HTMLFILE " var w = document.myform.mylist.selectedIndex; \n";
print HTMLFILE "if(u==0) return; \n";
print HTMLFILE "if(w==0) return; \n";
print HTMLFILE " var yeaR=document.year.mylist.options[u].value;\n";
print HTMLFILE "var dir = document.myform.mylist.options[w].value;\n";
...
print HTMLFILE "poz=yeaR+\'/\'+ dir + \'/\' + presetImagesTrk[i];\n";
...
print HTMLFILE "<form name=\"year\">\n";
print HTMLFILE "Jump to:\n";
print HTMLFILE "<select name=\"mylist\" onchange=\"nav()\">\n";
print HTMLFILE "<option value=\"-1\">Choose a year</option>\n";
print HTMLFILE "<option value=\"2011\">2011</option>\n";
print HTMLFILE "</select>\n";
print HTMLFILE "</form>\n";
print HTMLFILE "<form name=\"myform\">\n";
print HTMLFILE "Jump to:\n";
print HTMLFILE "<select name=\"mylist\" onchange=\"nav()\">\n";
print HTMLFILE "<option value=\"-1\">Choose a folder</option>\n";
print HTMLFILE "<option value=\"Collisions/JSON/MinimumBias\">JSON: Minimum Bias 2012</option>\n";
print HTMLFILE "</select>\n";
print HTMLFILE "</form>\n";
...
#-----------------------------------------------
	...
	$string = "$prefix <td align=\"center\"> <a id=\"Images".$image_count."\" href=\"" . $annotatejpegfile . "\"><img id=\"images".$image_count."\" src=\"" . $annotatejpegfile . "\" hspace=\"5\" vspace=\"5\" border=\"0\" alt=\"$jpegfile\"  width=\"400\" />  </a> \n  <br /> $annotatejpegfile </td> $suffix \n"; 
